...
#tmp="/volume1/homes/admin/script/OTR/tmp"
appdir=$(cd $(dirname $0);pwd)	# aktuelles Arbeitsverzeichnis auslesen
tmp="$appdir/tmp/otrcut"
tmp="$appdir/tmp"
...
#tmp="$tmp/otrcut" "/volume1/homes/admin/script/OTR/tmp"
else
